<x-admin-app-layout :title="'Users Edit - ' . config('app.name')">
    <!--begin::Layout-->
                    ...
                    <div class="d-flex flex-stack fs-4 py-3">
                        ...
                        <span data-bs-toggle="tooltip" data-bs-trigger="hover" title="Edit customer details">
                            <a href="#" class="btn btn-sm btn-light-primary" data-bs-toggle="modal"
                                data-bs-target="#kt_modal_update_details-{{ $user->id }}">Edit</a>
                        </span>
                    </div>
                    <!--end::Details toggle-->
                                ...
                                <div id="kt_schedule_day_0" class="tab-pane fade show">
                                    ...
                                    <div class="d-flex flex-stack position-relative mt-6">
                                        ...
                                        <div class="fw-bold ms-5">
                                            ...
                                            <!--begin::Title-->
                                            <a href="#"
                                                class="fs-5 fw-bolder text-dark text-hover-primary mb-2">Team Backlog
                                                Grooming Session</a>
                                            <!--end::Title-->
                                            <!--begin::User-->
                                            <div class="fs-7 text-muted">Lead by
                                ...
                                <div id="kt_schedule_day_1" class="tab-pane fade show active">
                                    ...
                                    <div class="d-flex flex-stack position-relative mt-6">
                                        ...
                                        <div class="fw-bold ms-5">
                                            ...
                                            <!--begin::Title-->
                                            <a href="#"
                                                class="fs-5 fw-bolder text-dark text-hover-primary mb-2">Sales Pitch
                                                Proposal</a>
                                            <!--end::Title-->
                                            <!--begin::User-->
                                            <div class="fs-7 text-muted">Lead by
                                    ...
                                    <div class="d-flex flex-stack position-relative mt-6">
                                        ...
                                        <div class="fw-bold ms-5">
                                            ...
                                            <!--begin::Title-->
                                            <a href="#"
                                                class="fs-5 fw-bolder text-dark text-hover-primary mb-2">9 Degree
                                ...
                                <div id="kt_schedule_day_2" class="tab-pane fade show">
                                    ...
                                    <div class="d-flex flex-stack position-relative mt-6">
                                        ...
                                        <div class="fw-bold ms-5">
                                            ...
                                            <!--begin::Title-->
                                            <a href="#"
                                                class="fs-5 fw-bolder text-dark text-hover-primary mb-2">Project Review
                                                &amp; Testing</a>
                                            <!--end::Title-->
                                            <!--begin::User-->
                                            <div class="fs-7 text-muted">Lead by
                                ...
                                <div id="kt_schedule_day_5" class="tab-pane fade show">
                                    ...
                                    <div class="d-flex flex-stack position-relative mt-6">
                                        ...
                                        <div class="fw-bold ms-5">
                                            ...
                                            <!--begin::Title-->
                                            <a href="#"
                                                class="fs-5 fw-bolder text-dark text-hover-primary mb-2">Weekly Team
                                                Stand-Up</a>
                                            <!--end::Title-->
                                            <!--begin::User-->
                                            <div class="fs-7 text-muted">Lead by
                    ...
                    <div class="card card-flush mb-6 mb-xl-9">
                        ...
                        <div class="card-body d-flex flex-column">
                            ...
                            <div class="d-flex align-items-center position-relative mb-7">
                                ...
                                <!--begin::Details-->
                                <div class="fw-bold ms-5">
                                    <a href="#" class="fs-5 fw-bolder text-dark text-hover-primary">Dashboard
    ...
    <div class="modal fade" id="kt_modal_update_details-{{ $user->id }}" tabindex="-1" aria-hidden="true">
        <!--begin::Modal dialog-->
                            ...
                            <div id="kt_modal_update_user_user_info" class="collapse show">
                                ...
                                <div class="fv-row mb-15">
                                    ...
                                    <select name="language" aria-label="Select a Language" data-control="select2"
                                        ...
                                        data-dropdown-parent="#kt_modal_update_details-{{ $user->id }}">
                                        <option></option>
